...
def get_version():
    ...
    version_file2 = os.path.join(
        HERE, EXP_DIR, "setup.py", "__init__.py")
...
setup(
    ...
    version=get_version(),
    author="Neha Gupta",
    author_email="nehastatsiitb@gmail.com",
    maintainer="Neha Gupta",
    maintainer_email="nehastatsiitb@gmail.com",
    url="https://github.com/nehastats/Model_code",
    description="End to end ML model development and deployment with mlflow and docker",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    download_url=(
        "https://github.com/nehastats/Model_code.git"
        if "dev" in get_version()
        else "https://github.com/nehastats/Model_code/"
